...
def wait_and_accept_keypress(line_index, station_index):
    counter = 0;
    while(counter < 100):
        ...
        time.sleep(.1)
        counter += 1
        return (line_index, station_index)
...
while True:
    try:
        ...
        line_index, station_index = wait_and_accept_keypress(line_index, station_index)
    pass
